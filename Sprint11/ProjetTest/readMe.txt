A- CONFIGURATION:
  ...
  4. Dans le fichier web.xml de votre projet, ajouter deux servlet:
	...
	-servlet-class: etu1762.framework.servlet.FrontServlet
	-url-pattern: /*
    (b) -servlet-name: jsp
	-url-pattern: /web/*
  5. Charger la librairie 'etu1762.jar' dans le projet
  6. Version Tomcat 8.5

B- UTILISATION:
  1. Toutes les class doivent comporter un constructeur vide
  2. Les class doivent importer les packages: 'etu1762.framework.annotation.AnnotationUrl' et 'etu1762.framework.ModelView'
